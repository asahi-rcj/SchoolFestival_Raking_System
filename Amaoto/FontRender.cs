...
namespace Amaoto
{
    ...
    public class FontRender
    {
        ...
        public FontRender(FontFamily fontFamily, int fontSize, Color ForeColor, Color BackColor, int edge = 0, FontStyle fontStyle = FontStyle.Regular)
        {
            this.FontFamily = fontFamily;
            this.FontSize = fontSize * 96.0f / 72.0f;
